          ...
          <el-table-column label="操作" width="120">
            <template slot-scope="scope">
              ...
              <el-dialog title="图片信息" :visible.sync="detailFormVisible" width="480px">
                <el-form :model="detailForm" status-icon :rules="rules" ref="addUserForm">
                  ...
                  <el-form-item label="图片内容" label-width="100px">
                    <img :src="detailForm.path" class="img-small" alt="图片内容解析失败">
                  </el-form-item>
                  ...
                  <el-form-item label="图片路径" label-width="100px">
                    <el-input v-model="detailForm.path" autocomplete="off" disabled></el-input>
                  </el-form-item>
                </el-form>
              </el-dialog>
            </template>
